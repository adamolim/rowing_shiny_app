...
# Données pour connecter l'ordi au server rsconnect::setAccountInfo(name='agathos1984', token='76E90A9EB716D4C2A4DFB84DE9918EFA', secret='y7eyGdqPfZ2UDqnmIyeAKrnK1p6n6YxX7tgZcntg')
    ...
    navbarMenu(
      ...
      tabPanel("Club",
               ...
               fluidPage(
                 ...
                 tags$div(tags$h2("Rowing Club")),
                 
                 # Add the description of the tabPanel with a new div tag
                 
                 tags$div(
                   tags$p(
                     "The club is so much more than numbers and figures. But why not have look on them, up to time? Here you can check 
                 ...
                 sidebarLayout(# Sidebar panel for inputs
                   ...
                   sidebarPanel(
                     ...
                     selectInput(
                       ...
                       label = "Select...",
                       choices = c(
                         "Kilometers of the club" = "DIST_KM",
      ...
      tabPanel("Groups",
               ...
               fluidPage(
                 ...
                 tags$div(tags$h2("Groups in the club")),
      ...
      tabPanel("Rowers",
               ...
               fluidPage(
                 ...
                 tags$div(tags$h2("Rowers in the club")),
                 
                 # Add the description of the tabPanel with a new div tag
                 
                 tags$div(
                   tags$b("How much do you row in the club?"),
                   tags$p(
    ...
    navbarMenu(
      ...
      tabPanel(
        ...
        fluidPage(
          ...
          tags$div(
            tags$b("Is the club rowing also in winter?"),
            tags$p(
      ...
      tabPanel("Scull or sweep",
               ...
               fluidPage(
                 ...
                 tags$div(
                   ...
                   tags$p(
                     "In the club, almost all rowers begins with sculling. 
...
server <- function(input, output) {
  ...
  output$Main_Data <- renderPlotly({
    ...
    ggplotly(
      ggplot(d.ANA.01, mapping = aes(x = YEAR, y = Value)) +
        ...
        geom_line(size = 0.3, color = color_club_official) +
        
        geom_point(aes(text = paste(Value, UNIT)), size = 2.5, color = color_club_official) +
  ...
  output$Gender_group <- renderPlotly({
    ...
    # Préparation pour les deux sexes
    ...
    ggplotly(
      ggplot(d.ANA.06.SEX,
        ...
        scale_colour_manual(values = color_club) +
  ...
  output$Sport_group <- renderPlotly({
    ...
    # Préparation pour les deux groupe de sport
  ...
  output$rowers_km <- renderPlotly({
    ...
    ggplotly(
      ggplot(
        ...
        scale_fill_manual(values = color_club),
      tooltip = "text"
    )
    ...
    ggplotly(
      ggplot(d.ANA.02) +
        ...
        geom_col(
          ...
          fill = color_club_light[4]
        ) +
        geom_line(
          mapping = aes(x = as.numeric(MONTH), y = Spot),
          size = 0.3,
          color = color_club_official
        ) +
        geom_point(
          mapping = aes(
            x = MONTH_NAME,
